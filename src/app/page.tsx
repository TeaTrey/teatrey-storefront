...
const perks = [
  ...
  },
  {
    ...
    icon: Leaf,
    description:
      "We plant a tree for every asset sold on our platform. We are committed to a greener future.",
  },
];
      ...
      <MaxWidthWrapper>
        <div className="py-20 mx-auto text-center flex flex-col items-center max-w-3xl">
          ...
          <p className="mt-6 text-lg max-w-prose text-muted-foreground">
            Welcome to TeaTrey. Every asset on our platform is verified by our
            ...
            {perks.map((perk) => (
              ...
              >
                <div className="md:flex-shrink-0 flex justify-center">
                  <div className="h-16 w-16 flex items-center justify-center roudned-full bg-primary text-primary-foreground">
